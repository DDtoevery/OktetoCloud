...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/talavinh/Okteto_SSH/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'You can play the awesome Cloud NOW! - Message from I am Vinh!' >/var/www/html/index.html
